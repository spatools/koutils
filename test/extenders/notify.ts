    ...
    describe("notify", () => {
        ...
        describe("when 'primitive' is passed as argument", () => {
            ...
            it("shoud notify subscribers if values are not equals and not primitive", () => {
                const
                    obj = { test: "test" },
                    obs = ko.observable<object>({ base: "test" }).extend({ notify: "primitive" }),
                    spy = sinon.spy();
        ...
        describe("when 'reference' is passed as argument", () => {
            ...
            it("shoud notify subscribers if values are not reference equals", () => {
                const
                    obj = { test: "test" },
                    obs = ko.observable<object>({ base: "test" }).extend({ notify: "reference" }),
                    spy = sinon.spy();
        ...
        describe("when 'manual' is passed as argument", () => {
            ...
            it("shoud notify subscribers if values are not reference equals", () => {
                const
                    obj = { test: "test" },
                    obs = ko.observable<object>({ base: "test" }).extend({ notify: "manual" }),
                    spy = sinon.spy();
